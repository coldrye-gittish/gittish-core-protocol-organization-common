# gittish-core-protocol-organization-common

This package defines common message types to be used when communicating with the
...
```
cd <WORKSPACE_ROOT>/gittish-core-protocol-organization-common
./configure
```
